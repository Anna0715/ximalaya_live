...
def Certification():
    ...
    conn = pymysql.connect(
        ...
        host='192.168.3.161',  # 指定访问的服务器，本地服务器指定“localhost”，远程服务器指定服务器的ip地址
        database='ops',  # 数据库的名字
    ...
    if da == None:
        cursor.execute(
            "INSERT INTO tb_white_anchor (uid,apply_name,dept_name,reason,ops_id,created_at,updated_at,sub_categoryId,is_deleted,audit_director) "
